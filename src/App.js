...
doc.setFont("helvetica");
      ...
      doc.text(
        `Por este conducto manifiesto que estoy en condiciones para iniciar el trámite de SOLICITUD DE 
${primerDato.tipo_de_solicitud} del programa ${primerDato.nivel} en ${primerDato.plan_de_estudios}, modalidad ${primerDato.modalidad}, en periodos
${primerDato.periodo}, turno ${primerDato.turno}, de la Institución ${primerDato.institucion}.`,20,200,{ align: 'justify', maxWidth: 175 });
...
doc.setFont("helvetica");
      ...
      doc.text(
        `Por este conducto manifiesto que estoy en condiciones para iniciar el trámite de SOLICITUD DE 
${primerDato.tipo_de_solicitud} del programa ${primerDato.nivel} en ${primerDato.plan_de_estudios}, modalidad ${primerDato.modalidad}, en periodos
${primerDato.periodo}, turno ${primerDato.turno}, de la Institución ${primerDato.institucion}.`,20,230,{ align: 'justify', maxWidth: 175 });
        ...
        generateTable(doc, headers, tableData, 90, {
