...
function FDA06() {
  useEffect(() => {
    ...
    const img3 =
      "https://pbs.twimg.com/profile_images/1587466002241134594/RCTlvwMC_400x400.jpg";
...
datos proporcionados en la solicitud DI2020484 cuenta con un inmueble con las condiciones
de seguridad, higiénicas necesarias para impartir el plan de estudios para el programa
TÉCNICO SUPERIOR UNIVERSITARIO EN HOTELERÍA, modalidad ESCOLARIZADA, en
periodos CUATRIMESTRAL, asimismo ACEPTA cumplir y se compromete con las siguientes
...
verifique el cumplimiento de esta obligación.`
        ...
        for (let i = 1; i <= totalPages; i++) {
          ...
          const pageNumberTextWidth =
            (doc.getStringUnitWidth(pageNumberText) *
